...
<body>
    ...
    <div class="main-card">
        <h2>Experience</h2>
        <h4 class="italic">Operating Systems Course Assistant ... 09/22 - 05/23</h4>
        <p>
            Assisted the Operating Systems class by explaining concepts and material to students in office hours. 
    ...
    <div class="main-card">
        ...
        <ul class="normal-list">
            <li >C/C++, C#, JavaScript, Python, HTML/CSS</li>
            <li>Node.js, Qt, React, Redux, SQL/SQLite</li>
            <li>Windows, Linux</li>
        </ul>
    </div>
    ...
    <div class="main-card">
        ...
        <p>Click <a href="/projects">here</a> to see my projects.</p>
    </div>
</body>